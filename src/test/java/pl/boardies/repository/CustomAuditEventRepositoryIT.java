package pl.boardies.repository;

import pl.boardies.BoardiesApp;
import pl.boardies.config.Constants;
import pl.boardies.config.TestSecurityConfiguration;
import pl.boardies.config.audit.AuditEventConverter;
import pl.boardies.domain.PersistentAuditEvent;
...
import static pl.boardies.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
